...
$string['manytasksreviewed'] = '{$a} devoirs ont été révisés';
$string['modaltitle'] = 'Retour IA';
$string['norecords'] = 'Aucun enregistrement trouvé';
$string['nostatus'] = 'Aucun retour';
$string['notasksfound'] = 'Aucun devoir à réviser';
$string['onetaskreviewed'] = '1 devoir a été révisé';
$string['pluginname'] = 'Devoir IA';
$string['qualify'] = 'Évaluer';
$string['review'] = 'Réviser';
$string['reviewall'] = 'Tout réviser';
$string['reviewwithai'] = 'Révision avec IA';
