...
$string['pluginname'] = 'Devoir IA';
$string['privacy:metadata:local_assign_ai_pending'] = 'Stocke les retours IA en attente d’approbation.';
$string['privacy:metadata:local_assign_ai_pending:approval_token'] = 'Jeton unique utilisé pour le suivi de l’approbation.';
$string['privacy:metadata:local_assign_ai_pending:assignmentid'] = 'Le devoir concerné par ce retour IA.';
...
$string['privacy:metadata:local_assign_ai_pending:rubric_response'] = 'Le retour de la grille d’évaluation généré par l’IA.';
$string['privacy:metadata:local_assign_ai_pending:status'] = 'Le statut d’approbation du retour.';
$string['privacy:metadata:local_assign_ai_pending:title'] = 'Le titre du retour généré.';
...
$string['reviewwithai'] = 'Examiner avec IA';
...
$string['submission_none'] = 'Aucun devoir remis';
