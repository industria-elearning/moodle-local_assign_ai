...
$string['manytasksreviewed'] = '{$a} devoirs ont été corrigés';
$string['modaltitle'] = 'Retour IA';
$string['norecords'] = 'Aucun enregistrement trouvé';
$string['nostatus'] = 'Aucun retour';
$string['notasksfound'] = 'Aucun devoir à corriger';
$string['onetaskreviewed'] = '1 devoir corrigé';
$string['pluginname'] = 'Assignment IA';
$string['qualify'] = 'Évaluer';
$string['review'] = 'Revoir';
$string['reviewall'] = 'Tout revoir';
$string['reviewwithai'] = 'Revue avec IA';
...
$string['submission_none'] = 'Aucun dépôt';
