...
$string['email'] = 'Email';
$string['error_airequest'] = 'Kesalahan berkomunikasi dengan layanan AI: {$a}';
$string['errorparsingrubric'] = 'Kesalahan saat menganalisis respons rubrik: {$a}';
$string['feedbackcomments'] = 'Komentar';
$string['fullname'] = 'Nama lengkap';
$string['grade'] = 'Nilai';
$string['gradesuccess'] = 'Nilai berhasil disuntikkan';
