...
$string['norecords'] = 'Tidak ada data ditemukan';
$string['nostatus'] = 'Tidak ada umpan balik';
$string['notasksfound'] = 'Tidak ada tugas untuk ditinjau';
$string['onetaskreviewed'] = '1 tugas ditinjau';
$string['pluginname'] = 'Tugas AI';
$string['privacy:metadata:local_assign_ai_pending'] = 'Menyimpan umpan balik tugas yang dihasilkan AI dan menunggu persetujuan.';
...
$string['privacy:metadata:local_assign_ai_pending:rubric_response'] = 'Umpan balik rubrik yang dibuat oleh AI.';
...
$string['qualify'] = 'Nilai';
$string['review'] = 'Tinjau';
$string['reviewall'] = 'Tinjau semua';
$string['reviewwithai'] = 'Tinjau dengan AI';
$string['save'] = 'Simpan';
...
$string['submission_none'] = 'Tidak ada pengiriman';
$string['submission_submitted'] = 'Dikirim';
$string['submittedfiles'] = 'Berkas yang dikirim';
