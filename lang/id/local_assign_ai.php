...
$string['privacy:metadata:local_assign_ai_pending:approval_token'] = 'Token unik yang digunakan untuk melacak persetujuan.';
...
$string['submittedfiles'] = 'File yang dikirim';
