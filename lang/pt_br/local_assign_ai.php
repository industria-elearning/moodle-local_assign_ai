...
$string['manytasksreviewed'] = '{$a} tarefas foram revisadas';
...
$string['onetaskreviewed'] = '1 tarefa foi revisada';
$string['pluginname'] = 'Tarefa IA';
...
$string['submission_none'] = 'Sem entrega';
