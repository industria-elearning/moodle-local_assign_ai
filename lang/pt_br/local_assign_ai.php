...
$string['privacy:metadata:local_assign_ai_pending'] = 'Armazena feedbacks gerados por IA pendentes de aprovação.';
$string['privacy:metadata:local_assign_ai_pending:approval_token'] = 'Token único usado para rastrear aprovações.';
$string['privacy:metadata:local_assign_ai_pending:assignmentid'] = 'A tarefa à qual este feedback da IA pertence.';
...
$string['privacy:metadata:local_assign_ai_pending:rubric_response'] = 'O feedback de rubrica gerado pela IA.';
